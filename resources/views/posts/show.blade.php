                            ...
                            <span class="text-center text-muted">{{ $post->caption }} </span> 
                                ...
                                <span class="font-weight-bold">  
                                    <a href="/profile/{{ $post->user->id }}">
                                        <span class="text-dark text-uppercase text-none  text-decoration-none ml-2"> {{ $post->user->fname }} {{ $post->user->lname }}</span>
                                    </a>
                                    
                                </span>
                                <p class="text-success ml-5 mt-2">Created At: {{ $post->created_at->format ('l j F Y') }} </p>
                            </div>
                    </div>
                </div>

                <div class="col-6 col1">
                    <div class="card shadow card-shad">
                        <div class="info-area">
                            ...
                            <a href="{{asset('storage')}}/{{$post->image}}" download class="btn btn-success "> Download </a>
